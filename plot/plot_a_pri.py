...
plt.scatter(value, nums, c='r', label='Money B owned')
plt.scatter(value, y_predict, c='b', label='Prediction with Gaussian Distribution')
plt.legend()
plt.title("Curve-fitting B's money with Gaussian Distribution")
plt.show()